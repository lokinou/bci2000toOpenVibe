function EEG = pop_loadBCI2000_no_bounds(fileName, events)
...
% Revision history:
%   0.36  Fixed: Non-PC import of multiple files had a bug where the
%         dimensionality of the file_samples variable was wrong. I also
%         removed the example data file.
%         Chadwick.Boulay@gmail.com 2015-03-02
...
if ispc
    ...
    file_samples = nan(1, length(files));
...
if 0 % length(files)>1 % MODIFIED TO PREVENT ALL EVENTS FROM THE LAST FILE TO BE REMOVED
